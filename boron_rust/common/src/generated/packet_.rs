...
impl<'a> JoinEvent<'a> {
  ...
  pub fn username(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(JoinEvent::VT_USERNAME, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> JoinEventBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_username(&mut self, username: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(JoinEvent::VT_USERNAME, username);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> JoinEventBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    JoinEventBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> LeaveEvent<'a> {
  ...
  pub fn username(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LeaveEvent::VT_USERNAME, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LeaveEventBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_username(&mut self, username: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LeaveEvent::VT_USERNAME, username);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> LeaveEventBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    LeaveEventBuilder {
      fbb_: _fbb,
      start_: start,
    ...
    v.visit_table(pos)?
     .visit_union::<Packet_Data, _>("data_type", Self::VT_DATA_TYPE, "data", Self::VT_DATA, false, |key, v, pos| {
        match key {
          ...
          Packet_Data::JoinEvent => v.verify_union_variant::<flatbuffers::ForwardsUOffset<JoinEvent>>("Packet_Data::JoinEvent", pos),
          Packet_Data::LeaveEvent => v.verify_union_variant::<flatbuffers::ForwardsUOffset<LeaveEvent>>("Packet_Data::LeaveEvent", pos),
          _ => Ok(()),
        }
     })?
     .finish();
